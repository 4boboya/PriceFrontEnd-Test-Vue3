<template>
  <div class="step">
    <div class="step-title">
      <span :active="nowStep == 'option'" class="link" @click="toOption">選擇方案</span>
      <span :active="nowStep == 'method'">付費方式</span>
      <span :active="nowStep == 'success'">儲值成功</span>
    </div>
